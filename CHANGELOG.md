...
- Style **90s Sony**: VFD cyan/turquoise bars, top-2 overload amber-red, smoked opaque backdrop, cheap fake glow (no blur), 500 ms peak hold + slower gravity (style-only).
